...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "DNBSNGUI" /productName "DNBSNGUI" > NUL
...
COPY /Y "DNBSNGUI.msha" HelpContentSetup.msha
